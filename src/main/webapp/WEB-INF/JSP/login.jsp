			...
			<div class="content_wrap clearfix">
				...
				<c:url var="loginurl" value="/login" />
					<form action="${loginurl}" method="post">
						...
						<div>
						<p><label for="emailadres">Emailadres:</label></p>
						...
						<c:if test="${param.error != null}">
							<p><span class="fout">Verkeerde gebruikersnaam of wachtwoord</span></p>
						</c:if>
						</div>
						<div>
				...
				<c:url var='url' value='/gebruiker' />
					<form:form action="${url}" commandName="gebruiker" method="post">
						...
						<div>
						<p><form:label path="voornaam" for="voornaam">Voornaam:</form:label></p>
						<p><form:input path="voornaam" type="text" id="voornaam" title="voer uw voornaam in" /></p>
						<p><form:errors path="voornaam" cssClass="fout" /></p>
						</div>
						<div>
						<p><form:label path="familienaam" for="familienaam">Familienaam:</form:label></p>
						...
						<div>
						<p><form:label path="emailadres" for="emailadres_nieuw">Emailadres:</form:label></p>
						...
						<div>
						<p><form:label path="adres.nummer" for="huisnr">Huisnummer:</form:label></p>
						...
						<div>
						<p><form:label path="wachtwoord" for="wachtwoord_nieuw">Wachtwoord:</form:label></p>
						...
						<div>
						<p><form:label path="wachtwoordBevestig" for="wachtwoord_bevestig">Bevestig uw wachtwoord:</form:label></p>
